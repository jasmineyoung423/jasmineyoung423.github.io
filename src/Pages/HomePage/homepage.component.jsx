      ...
      return (
        <div>
            <div className="cover d-flex align-items-center justify-content-center">
              <h1 className="mainText boxText">Hi, I'm Jasmine. I love coding! I like being able to create apps and games in mixed reality that can make learning fun, or to relax to after a long day.</h1>
