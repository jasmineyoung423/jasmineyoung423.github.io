    ...
    return (
      <div>
        <div className="topDescriptionBlock">
          <h1 className="pageHead">Block Builder</h1>
          <p className = "descriptionText">This block building game was inspired by the building component of Mine Craft. </p>
        </div>
        ...
        <div className="cardGrid">
          <div className="techContainer">
            ...
            <a className="techText lightText" href="https://github.com/BridgerP/GIMM-400/tree/jasmine/UnrealMinigame" rel="noopener noreferrer" target="_blank">View Code on GitHub!</a>
          </div>
          <div className="techContainer">
