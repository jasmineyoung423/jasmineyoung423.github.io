    ...
    render() {
        return (
            <div>
                ...
                <div className="descriptionContainer">
                    <div className="descriptionTextContainer">
                        <p className="descriptionText"> I developed the basic app with Kotlin in Android Studio. Here is a quick video I made for the class to show the app built to and working on my phone. (Unfortunately, the video has no sound. I would suggest playing it on 1.5x speed, as video editing is not a skill of mine.)</p>
                    </div>
                    <div className="descriptionImageContainer">
